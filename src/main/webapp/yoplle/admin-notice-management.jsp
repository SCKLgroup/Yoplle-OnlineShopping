			...
			<div id="content">
				...
				<button type="button" class="primary-btn selectDelete_btn">삭제</button>
						...
						<div class="table-responsive">
							...
							<input type="hidden" id="jobVal" value=""> <input
								type="hidden" id="sortVal" value="">
						</div>
						<!-- /.container-fluid -->
				...
				function ajaxlist(v) {
					...
					$
							.each(
									v.list,
									function(index, dom) {
										temp += "<tr class=\"tableTextPos\">";
										temp += "<td><input type=\"checkbox\" id=\"chBox\"class=\"js-check-all chBox\" data-noticeNom=\""+dom.NOTI_NO+"\" /></td>";
										temp += "<td>[" + dom.NOTI_NO
												+ "]</td>";
										temp += "<td><a href=\"/yoplle/view.do?bno=${row.NOTI_NO}\">"
												+ dom.NOTI_TITLE + "</a></td>";
										temp += "<td><input value=\""+dom.EMP_NO+"\" type=\"hidden\">요플레</td>";
										temp += "<td><fmt:formatDate value=[\""+dom.NOTI_DATE+"\"pattern=\"yyyy-MM-dd HH:mm:ss\" /></td>";
										temp += "<td>[" + dom.NOTI_HIT
												+ "]</td>";
										temp += "</tr>";
									});
